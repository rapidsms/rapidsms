...
class TestFakeTime (TestScript):
    ...
    def test_all(self):
        ...
        self.assertTrue(schedule.should_fire(start + sec + min + hour + day +
                                                week))
    ...
    def test_days_of_week(self):
        ...
        self.assertFalse(schedule.should_fire(start + 5 * day + 8 * hour +
                                                16 * min))
        self.assertFalse(schedule.should_fire(start + 7 * day + 8 * hour +
                                                25 * min))
        self.assertFalse(schedule.should_fire(start + 3 * day + 8 * hour +
                                                15 * min))
        self.assertFalse(schedule.should_fire(start + 5 * day + 17 * hour +
                                                15 * min))
        self.assertTrue(schedule.should_fire(start + 8 * hour + 15 * min))
        self.assertTrue(schedule.should_fire(start + 17 * hour + 15 * min))
        self.assertTrue(schedule.should_fire(start + 4 * day + 8 * hour +
                                                15 * min))
        self.assertTrue(schedule.should_fire(start + 6 * day + 17 * hour +
                                                15 * min))
    ...
    def test_month(self):
        ...
        self.assertTrue(schedule.should_fire(start + month + sec + min + hour
                                            + day))
